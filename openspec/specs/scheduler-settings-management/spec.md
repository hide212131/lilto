# scheduler-settings-management Specification

## Purpose
Defines requirements for managing cron schedules through the Settings UI, including display and deletion of active schedules.
