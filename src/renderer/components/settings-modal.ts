        ...
        <div class="settings-modal">
          ...
          <div class="settings-body">
            <div class="settings-menu">
              <div
                class="settings-menu-item ${this._activeSection === "providers" ? "active" : ""}"
                @click=${() => { this._activeSection = "providers"; }}
              >Providers &amp; Models</div>
              <div
                class="settings-menu-item ${this._activeSection === "chat" ? "active" : ""}"
                @click=${() => { this._activeSection = "chat"; }}
              >Chat</div>
            </div>
            <div class="settings-main">
              ${this._activeSection === "providers" ? this._renderProvidersSection(isClaudeActive, isCustomActive, authPhase, authMessage, codeInputEnabled, oauthBtnDisabled) : ""}
              ${this._activeSection === "chat" ? this._renderChatSection() : ""}
            </div>
          </div>
        </div>
      </div>
