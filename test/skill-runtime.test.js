...
test("Codex home は appDataDir 配下に分離される", () => {
  assert.equal(resolveCodexHomeDir("/tmp/lilto-user-data"), path.join("/tmp/lilto-user-data", "codex"));
});
...
test("checkSkillUpdates: symlink されたスキルディレクトリも更新確認対象になる", async () => {
